...
// Tool Versions: 
// Description: 
//      bitboard check for right diagonal win logic
// Dependencies: 
// 
// Revision:
...
module right_diag_check( 
    ...
    always @(posedge clk) begin
        if (state == 4) begin //p2 win state
            $display("[%0t ns] Player 2 has won!", $time); 
        end
    end
