...
// Tool Versions: 
// Description: 
//      bitboard check for left diagonal win logic
// Dependencies: 
// 
// Revision:
...
module left_diag_check( 
    ...
    always @(posedge clk) begin
        if (state == 4) begin //p1 win state
            $display("[%0t ns] Player 2 has won!", $time); //%0t to print time in log without extra space
        end
    end
