...
module ascii_rom(
	input clk, 
	input wire [10:0] addr, //cant make an input a reg 
	output reg [7:0] data
	);

	(* rom_style = "block" *)	// Infer ROM as Block RAM (BRAM needs a clk edge - addr_reg - and a lot of data - case tables (depends only on addr_reg)

	reg [10:0] addr_reg; //[10:4] -> ASCII character; [3:0] -> which row to output 
	
	always @(posedge clk)
		addr_reg <= addr; //assign wire to reg (delays by one clk; need to sync in VGA module by offsetting by one clk)
	...
	always @*
		case(addr_reg)
			...
			// code x5b ([)
            11'h5B0: data <= 8'b00111100; //   ****  
            11'h5B1: data <= 8'b00110000; //   **    
            11'h5B2: data <= 8'b00110000; //   **    
            ...
            11'h5BB: data <= 8'b00110000; //   **    
            11'h5BC: data <= 8'b00110000; //   **    
            11'h5BD: data <= 8'b00110000; //   **    
            11'h5BE: data <= 8'b00111100; //   ****  
            11'h5BF: data <= 8'b00000000; //    added
			// code x5c (\)
			...
			// code x5d (])
            11'h5D0: data <= 8'b00111100; //   ****  
            11'h5D1: data <= 8'b00001100; //     **  
            11'h5D2: data <= 8'b00001100; //     **  
            ...
            11'h5DB: data <= 8'b00001100; //     **  
            11'h5DC: data <= 8'b00001100; //     **  
            11'h5DD: data <= 8'b00001100; //     **  
            11'h5DE: data <= 8'b00111100; //   ****  
            11'h5DF: data <= 8'b00000000; //   was not originally here
			// code x5e (^)
